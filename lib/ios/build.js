...
const { MANIFEST_DOWNLOAD_URL, MANIFEST_DISPLAY_IMAGE_URL, MANIFEST_FULL_IMAGE_URL } = process.env;
...
module.exports = async function build (argv) {
  const { buildPath, archivePath, iosSearchPath, profile, profileuuid, method, bundleId } = argv;
